...
const LoginPage = () => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        // IMPORTANT: The backend's OAuth2PasswordRequestForm expects the
        // email to be sent in a field named 'username'. This is a standard
        // convention, so we send the email state under the 'username' key.
        const formBody = new URLSearchParams();
        formBody.append('username', email); // We send the email as 'username'
